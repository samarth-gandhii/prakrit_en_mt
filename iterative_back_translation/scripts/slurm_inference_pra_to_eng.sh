#!/bin/bash
#SBATCH --job-name=ibt_infer_pr2en
...
# ============================================================
# Prakrit → English inference
# Takes monolingual Prakrit, infers English via Pr→En model,
# produces parallel TSV used to fine-tune the En→Pr model.
# ============================================================
